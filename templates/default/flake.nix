        ...
        modules = [
...

          {
            ...
            itera = {
              ...
              #                         and stream URLs. GPU decoding is OFF by
              #                         default (it depends on the host, and can
              #                         corrupt the picture on a two-GPU machine)
              #                         — desktop.videoPlayer.hardwareDecoding
              #                         = true after checking it on yours
